...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>{{$typeinfos->seotitle}}</title>
	<meta name="keywords" content="{{$typeinfos->keywords}}" />
	<meta name="description" content="{{$typeinfos->description}}" />
...
<div class="main clearfix">
	...
	<div class="rec_brand_list">
		<ul>
			...
			<li><a href="{{substr($typeinfos->typedir,0,-1)}}{{$articles->typedir}}{{$articles->id}}.shtml" target="_blank" title="{{$articles->shorttitle}}" class="pic"><img src="{{$articles->litpic}}" alt="{{$articles->shorttitle}}"><em>{{$articles->shorttitle}}</em></a></li>
			@endforeach
		</ul>
	</div>
	<!--推荐品牌 结束-->
	...
	<div class="w910">
		<div class="order_item">
			...
			<div class="order_item_r">共找到<span>{{$articlelists->total()}}</span>个零食品牌加盟项目</div>
		</div>
		...
		<div class="brand_list" id="productBox">
			...
			<div class="brand_list_item">
				<div class="pro-Img fl">
					<a target="_blank" href="{{substr($typeinfos->typedir,0,-1)}}{{$articlelist->typedir}}{{$articlelist->id}}.shtml" class="pp-pic-name" title="{{$articlelist->shorttitle}}"><img src="{{$articlelist ->litpic}}" alt="{{$articlelist ->shorttitle}}"></a>
					<p class="pro_p">{{$articlelist ->description}}</p>
				</div>
				<div class="indrouce-r fl">
					<div class="list list-one">
						<a target="_blank" href="{{substr($typeinfos->typedir,0,-1)}}{{$articlelist->typedir}}{{$articlelist->id}}.shtml" title="{{$articlelist->shorttitle}}"><h3 class="list-Name fl">{{$articlelist->shorttitle}}</h3></a>
					...
					<div class="list-three">
						...
						<a href="{{substr($typeinfos->typedir,0,-1)}}{{$articlelist->typedir}}{{$articlelist->id}}.shtml" target="_blank" class="squaer xiangqing fl">项目详情</a>
		...
		<div class="side_news">
           ...
           <div class="common_list">
               <ul>
                   ...
                   <li><a href="{{substr($typeinfos->typedir,0,-1)}}{{$tjarticle->typedir}}{{$tjarticle->id}}.shtml" target="_blank" title="{{$tjarticle->title}}">{{$tjarticle->title}}</a></li>
            		@endforeach
               </ul>
           </div>
		</div>
