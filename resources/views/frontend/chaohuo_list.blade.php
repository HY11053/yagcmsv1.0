...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>{{$this_typeinfo->seotitle}}</title>
	<meta name="keywords" content="{{$this_typeinfo->keywords}}" />
	<meta name="description" content="{{$this_typeinfo->description}}" />
	...
	<div class="cate_sort">
		  ...
		  <dl>
			<dt>项目分类</dt>
				...
				<dd><a target="_self" href="#">咖啡</a></dd>   		
				<dd><a target="_self" href="#">甜品</a></dd>   		
				<dd><a target="_self" href="#">快餐</a></dd>   		
				<dd><a target="_self" href="#">小吃</a></dd>   		
				<dd><a target="_self" href="#">西餐</a></dd>   		
				<dd><a target="_self" href="#">烧烤</a></dd>   		
				<dd><a target="_self" href="#">茶叶</a></dd>   		
				<dd><a target="_self" href="#">烘焙</a></dd>   		
				<dd><a target="_self" href="#">饮品</a></dd>   		
				<dd><a target="_self" href="#">面馆</a></dd>
				<dd><a target="_self" href="#">休闲食品</a></dd>
				<dd><a target="_self" href="#">熟食</a></dd>
				<dd><a target="_self" href="#">火锅</a></dd>
				<dd><a target="_self" href="#">中餐</a></dd>
				<dd><a target="_self" href="#">酒水</a></dd>
		  </dl>
		  <dl>
			<dt>投资金额</dt>
				<dd><a class="hover" target="_self" href="#">全部</a></dd>
	...
	<div class="rec_brand_list">
		<ul>
			@foreach($article as $articles)
				<li><a href="{{substr($this_typeinfo->typedir,0,-1)}}{{$articles->typedir}}{{$articles->id}}.shtml" target="_blank" title="{{$articles->shorttitle}}" class="pic"><img src="{{$articles->litpic}}" alt="{{$articles->shorttitle}}"><em>{{$articles->shorttitle}}</em></a></li>
			@endforeach
		</ul>
	</div>
	<!--推荐品牌 结束-->
		...
		<div class="brand_list" id="productBox">
			...
			<div class="brand_list_item">
				<div class="pro-Img fl">
					<a target="_blank" href="{{$this_typeinfo->typedir}}{{$articlelist->id}}.shtml" class="pp-pic-name" title="{{$articlelist->shorttitle}}"><img src="{{$articlelist ->litpic}}" alt="{{$articlelist ->shorttitle}}"></a>
					<p class="pro_p">{{$articlelist ->description}}</p>
				</div>
				<div class="indrouce-r fl">
					<div class="list list-one">
						<a target="_blank" href="{{$this_typeinfo->typedir}}{{$articlelist->id}}.shtml" title="{{$articlelist->shorttitle}}"><h3 class="list-Name fl">{{$articlelist->shorttitle}}</h3></a>
					...
					<div class="list-three">
						...
						<a href="{{substr($this_typeinfo->typedir,0,-1)}}{{$articlelist->typedir}}{{$articlelist->id}}.shtml" target="_blank" class="squaer xiangqing fl">项目详情</a>
						<span class="byb_btn"><label><input type="checkbox" id="Db_64806" cid="64806" class="checkbox" data-pro='{"pid":{{$articlelist->id}},"name":"{{$articlelist->shortitle}}","pic":"{{$articlelist->litpic}}","url":"http://zf.qudao.com/xm/64806.html"}'>
						项目比一比</label></span>
					</div>
				</div>
			</div>
