		...
		<div class="brand_list" id="productBox">
			...
			<div class="brand_list_item">
				<div class="pro-Img fl">
					<a target="_blank" href="{{substr($this_typeinfo->typedir,0,-1)}}{{$articlelist->typedir}}{{$articlelist->id}}.shtml" class="pp-pic-name" title="{{$articlelist->shorttitle}}"><img src="{{$articlelist ->litpic}}" alt="{{$articlelist ->shorttitle}}"></a>
					<p class="pro_p">{{$articlelist ->description}}</p>
				</div>
				<div class="indrouce-r fl">
					<div class="list list-one">
						<a target="_blank" href="{{substr($this_typeinfo->typedir,0,-1)}}{{$articlelist->typedir}}{{$articlelist->id}}.shtml" title="{{$articlelist->shorttitle}}"><h3 class="list-Name fl">{{$articlelist->shorttitle}}</h3></a>
