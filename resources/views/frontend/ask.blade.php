				...
				<div class="col-sm-12 col-md-9 aw-main-content">
						...
						<div class="mod-body">
							<div class="aw-common-list">
								...
								<div class="aw-item active" data-topic-id="1159,">
									<a class="aw-user-name hidden-xs" data-id="3675" href="#" rel="nofollow"><img src="http://wenda.golaravel.com/uploads/avatar/000/00/36/75_avatar_max.jpg" alt=""></a>	<div class="aw-question-content">
										<h4>
											<a href="/ask/{{$asklist->id}}.shtml">{{$asklist->title}}</a>
										</h4>
										<a href="/ask/{{$asklist->id}}.shtml#!answer_form" class="pull-right text-color-999">回复</a>

										<p>
											<a href="http://wenda.golaravel.com/people/peng" class="aw-user-name">peng</a>
				<span class="text-color-999">发起了问题 • {{rand(0, $asklist->viewnum)}} 人关注 •  {{intval($asklist->answernum)}} 个回复 • {{$asklist->viewnum}} 次浏览 • {{$asklist->time}}</span>
