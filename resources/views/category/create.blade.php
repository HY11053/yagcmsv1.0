                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form class="form-horizontal form-label-left" method="post" action="/category/create"  enctype="multipart/form-data" novalidate>
                                    {{ csrf_field() }}
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-5 col-sm-6 col-xs-12">
                                            <input id="typename" class="form-control col-md-7 col-xs-12"  name="typename" placeholder="零食店加盟品牌大全" required="required" type="text">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-5 col-sm-9 col-xs-12">
                                            ...
                                            <select name="reid" class="form-control">
                                                ...
                                                @foreach ($data as $typedata)
                                                    ...
                                                    <option value="{{ $typedata->id }}"  @if ($typedata->id == $inputid ) selected="selected" @endif  @if ($typedata->reid != 0 )Disabled @endif>{{ $typedata->typename }}</option>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-5 col-sm-6 col-xs-12">
                                            <input type="text" id="typedir" name="typedir"  data-validate-length-range="16" data-validate-words="1" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-5 col-sm-6 col-xs-12">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" id="seotitle" name="seotitle" placeholder="零食店加盟品牌大全" required="required" type="text" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-5 col-sm-6 col-xs-12">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" id="keywords" name="keywords" placeholder="零食店加盟品牌大全" required="required" type="text" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-5 col-sm-6 col-xs-12">
                                            <input type="text" 	data-parsley-type="number" id="sortrank" name="sortrank" required="required" placeholder="www.website.com" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
