                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form action="/ask/update" method="post" data-parsley-validate class="form-horizontal form-label-left">
                                    {!! csrf_field() !!}
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input type="text" id="asktitle" name="asktitle" value="{{$title}}" required="required" class="form-control col-md-7 col-xs-12">
                                        </div>
                                    </div>
                                    ...
                                    <div style="display: none"><textarea  name="textareacontent" id="lawsContent">{{$description}}</textarea></div>
