                                        ...
                                        <div class="block_content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="col-md-8 col-sm-9 col-xs-12">
                                                        <input type="text" name="brandtime" id="brandtime" class="form-control col-md-10" value="{{ $brand->brandtime }}" placeholder="1.5万元"/>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="control-label col-md-4 col-sm-3 col-xs-12">首批进货费</label>
                                                    <div class="col-md-8 col-sm-9 col-xs-12">
                                                        <input type="text" name="brandorigin" id="brandorigin" class="form-control col-md-10" value="{{ $brand->brandorigin }}" placeholder="6万元"/>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="control-label col-md-4 col-sm-3 col-xs-12">广告宣传费</label>
                                                    <div class="col-md-8 col-sm-9 col-xs-12">
                                                        <input type="text" name="brandnum" id="brandnum" class="form-control col-md-10" value="{{ $brand->brandnum }}" placeholder="0.4万元"/>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="control-label col-md-4 col-sm-3 col-xs-12">水电杂费</label>
                                                    <div class="col-md-8 col-sm-9 col-xs-12">
                                                        <input type="text" name="brandpay" id="brandpay" class="form-control col-md-10" value="{{ $brand->brandpay }}" placeholder="1200元"/>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="control-label col-md-4 col-sm-3 col-xs-12">流动资金</label>
                                                    <div class="col-md-8 col-sm-9 col-xs-12">
                                                        <input type="text" name="brabdaea" id="brabdaea" class="form-control col-md-10" value="{{ $brand->brabdaea }}" placeholder="4万元"/>
                                                    </div>
                                                </div>
