...
//列表文档获取及分页，id为传入的栏目id
    ...
    function getIndex(Request $request){
        ...
        //推荐品牌
        $recommenbrand=$this->getFlagarticle(1,'c',1);
        //品牌头条
        $apexbrand=$this->getFlagarticle(1,'',5);
        $scrollchaohuobrand=$this->getFlagarticle(8,'',1);
        $chaohuobrands=$this->getFlagarticle(8,'',5 ,1);
        //进口零食品牌
        $hotimportbrand=$this->getFlagarticle(9,'',1);
        $importbrand=$this->getFlagarticle(9,'',5,1);
        //创业大讲堂
        $recommennews=$this->getFlagarticle(3,'',8);
        $askrows=DB::table('asks')->where('answernum','>',0)->orderBy('answernum','desc')->limit(8)->get();
